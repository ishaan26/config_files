# Generated by Powerlevel10k configuration wizard on 2020-06-23 at 16:35 IST.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    history                 # Shows the number of commands ran in all of eternity of your os install
  ...
  ##########################[ history: number of commands ran ]###########################
