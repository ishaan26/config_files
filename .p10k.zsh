# Generated by Powerlevel10k configuration wizard on 2020-06-22 at 21:32 IST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 15764.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# round separators, slanted heads, flat tails, 2 lines, disconnected, no frame, sparse,
...
() {
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=016
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND=041
  # Custom icon.
