        ...
        default_tab_template {
            ...
            pane size=2 borderless=true {
                plugin location="file://${pkgs.zjstatus}/bin/zjstatus.wasm" {
                    ...
                    format_center ""
                    format_right  "#[bg=#${colors.base00},fg=#${colors.base0D}]█#[bg=#${colors.base0D},fg=#${colors.base01},bold] 󰒋 #[bg=#${colors.base00},fg=#${colors.base0D}]█#[bg=#${colors.base00},fg=#${colors.base05},bold] {command_host}"
                    ...
                    mode_search        "#[bg=#${colors.base0D},fg=#${colors.base02},bold] SEARCH #[bg=#${colors.base00},fg=#${colors.base0D}]█"
                    ...
                    tab_normal              "#[bg=#${colors.base00},fg=#${colors.base0D}]█#[bg=#${colors.base0D},fg=#${colors.base02},bold]{index} #[bg=#${colors.base02},fg=#${colors.base05},bold] {name}{floating_indicator}#[bg=#${colors.base00},fg=#${colors.base02}]█"
                    tab_normal_fullscreen   "#[bg=#${colors.base00},fg=#${colors.base0D}]█#[bg=#${colors.base0D},fg=#${colors.base02},bold]{index} #[bg=#${colors.base02},fg=#${colors.base05},bold] {name}{fullscreen_indicator}#[bg=#${colors.base00},fg=#${colors.base02}]█"
                    tab_normal_sync         "#[bg=#${colors.base00},fg=#${colors.base0D}]█#[bg=#${colors.base0D},fg=#${colors.base02},bold]{index} #[bg=#${colors.base02},fg=#${colors.base05},bold] {name}{sync_indicator}#[bg=#${colors.base00},fg=#${colors.base02}]█"

                    // formatting for the current active tab
                    tab_active              "#[bg=#${colors.base00},fg=#${colors.base09}]█#[bg=#${colors.base09},fg=#${colors.base02},bold]{index} |#[bg=#${colors.base09},fg=#${colors.base02},bold] {name}{floating_indicator}#[bg=#${colors.base00},fg=#${colors.base09}]█"
                    tab_active_fullscreen   "#[bg=#${colors.base00},fg=#${colors.base09}]█#[bg=#${colors.base09},fg=#${colors.base02},bold]{index} |#[bg=#${colors.base09},fg=#${colors.base02},bold] {name}{fullscreen_indicator}#[bg=#${colors.base00},fg=#${colors.base09}]█"
                    tab_active_sync         "#[bg=#${colors.base00},fg=#${colors.base09}]█#[bg=#${colors.base09},fg=#${colors.base02},bold]{index} |#[bg=#${colors.base09},fg=#${colors.base02},bold] {name}{sync_indicator}#[bg=#${colors.base00},fg=#${colors.base09}]█"
